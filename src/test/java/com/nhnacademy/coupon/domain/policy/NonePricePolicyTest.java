...
class NonePricePolicyTest {
    ...
    void testGetDiscountValue() {
        CouponPolicy policy = new NonePricePolicy(1L,"qwe",null,null,90D, CouponDiscountType.RATE);
        Assertions.assertThat(policy.match()).isTrue();
        Assertions.assertThat(policy.getDiscountAmount(new Price(100L)).value()).isEqualTo(90L);
    }
