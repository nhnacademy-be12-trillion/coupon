...
class AllPricePolicyTest {
    ...
    void testGetMaxDiscountPrice() {
        CouponPolicy policy = new AllPricePolicy(1L,200L,1000L,0.20D,CouponDisCountType.RATE);
    ...
    void testGetMaxDiscountPrice1() {
        CouponPolicy policy = new AllPricePolicy(1L,100L,10L,0.90D,CouponDisCountType.RATE);
    ...
    void test2() {
        CouponPolicy policy = new AllPricePolicy(1L,100L,1000L,0.1D,CouponDisCountType.RATE);
        Assertions.assertThat(policy.getSalePrice(new Price(100L)).value()).isEqualTo(10L);
    }
    @Test
