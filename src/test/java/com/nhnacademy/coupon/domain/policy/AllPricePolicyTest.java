...
class AllPricePolicyTest {
    ...
    void testGetMaxDiscountPrice() {
        CouponPolicy policy = new AllPricePolicy(1L,"qwe",200L,1000L,20D, CouponDiscountType.RATE);
    ...
    void testGetMaxDiscountPrice1() {
        CouponPolicy policy = new AllPricePolicy(1L,"qwe",100L,10L,90D, CouponDiscountType.RATE);
    ...
    void test2() {
        CouponPolicy policy = new AllPricePolicy(1L,"qwe",100L,1000L,10D, CouponDiscountType.RATE);
        Assertions.assertThat(policy.getDiscountAmount(new Price(100L)).value()).isEqualTo(10L);
    }
    @Test
