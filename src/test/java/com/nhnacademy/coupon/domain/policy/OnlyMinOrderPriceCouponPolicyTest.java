...
class OnlyMinOrderPriceCouponPolicyTest {
    ...
    void testGetMaxDiscountPrice1() {
        CouponPolicy policy = new OnlyMinOrderPriceCouponPolicy(1L,"qwe",100L,1000L,20D, CouponDiscountType.RATE);
    ...
    void test3() {
        CouponPolicy policy = new OnlyMinOrderPriceCouponPolicy(1L,"qwe",100L,null,1D, CouponDiscountType.RATE);
